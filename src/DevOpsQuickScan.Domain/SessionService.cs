...
public class SessionService(ISessionDataRepository sessionDataRepository, ILogger<SessionService> logger)
{
    ...
    // TODO: Use unique identifiers for sessions
    ...
    private async Task SaveState(StateMachine<SessionState, SessionTrigger>.Transition arg)
    {
